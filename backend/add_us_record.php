                    ...
                    <div class="col-md-6">
                      <img class="w-50" src="../api/dog/uploads/<?= $row['image']; ?>" alt="">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 1%;">
                                        <input value="<?= $row['usrec_topic']; ?>" type="text" class="form-control" id="inputdogname" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="radio">
                                            <label class="radio-inline ml-3"><input type="radio" value="usrec_weird" name="pref2" checked> สุนัขมีอาการผิดปกติ </label>
                                            <label class="radio-inline ml-5"><input type="radio" value="usrec_normal" name="pref2"> สุนัขปกติดี </label>
                                        </div>

                                        <div class="col-md-4 ml-4">
                                            <input type="checkbox" name="usrec_topic[]" value="กินน้ำเยอะ">
                                            <label for="usrec_topic1"> กินน้ำเยอะ</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="หายใจเร็วผิดปกติ">
                                            <label for="usrec_topic2"> หายใจเร็วผิดปกติ</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="มีอาการท้องเสีย">
                                            <label for="usrec_topic3"> มีอาการท้องเสีย</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="อาเจียนบ่อย">
                                            <label for="usrec_topic4"> อาเจียนบ่อย</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="มีอาการไอเรื้อรัง">
                                            <label for="usrec_topic5"> มีอาการไอเรื้อรัง</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="มีอาการซึมเศร้า">
                                            <label for="usrec_topic6"> มีอาการซึมเศร้า</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="ไม่ยอมกินข้าว">
                                            <label for="usrec_topic7"> ไม่ยอมกินข้าว</label><br>
                                            <input type="checkbox" name="usrec_topic[]" value="น้ำหนักลดลง">
                                            <label for="usrec_topic8"> น้ำหนักลดลง</label><br>
                                        </div>
                                    </div>
