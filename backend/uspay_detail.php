    ...
    <div class="wrapper">
                                ...
                                <div class="content table-full-width">
                                    <table style="border: 2px solid black;" class="table table-striped table-bordered ">
                                        <thead>
                                            ...
                                            ?>
                                                <tr style="border: 2px solid black;">
                                                    ...
                                                    <th style="padding-left: 10%; padding-top: 2%; padding-bottom: 2%;  font-size: 16px;" rowspan="4" colspan="3">รหัสสุนัข : <?= $row['dog_id'] ?><br>ชื่อ : <?= $row['dog_name'] ?><br>พันธุ์ : <?= $row['dog_type'] ?><br>อายุ : <?= $row['dog_age'] ?> ปี</th>
                                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th style="border: 2px solid black; padding-left: 66%;" rowspan="1" colspan="4">รวมเป็นเงิน (Total) </th>
                                                <th style="border: 2px solid black;" class="text-center" rowspan="1" colspan="4"><?= $row['us_price'] ?></th>
                                            </tr>
        ...
        <script>
            $("#updateForm").submit(function(e) {
                ...
                $.post('../api/pay/us_pay.php', formData, function(data) {
                    if (data.success) {
                        swal("แจ้งเตือน", "อัปเดตสถานะการชำระสำเร็จ", "success").then(function() {
                            window.location = "us_pay.php";
                        })
                    } else {
