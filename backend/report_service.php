                                ...
                                <div class="card">
                                    <form action="report_service.php" method="get">
                                        <div class="card-header form-inline">
                                            ...
                                            <?php } else { ?>
                                                <a href="generate_pdf.php?action=report_service&status=all" target="_blank" class="btn btn-primary active ml-4"><i class="fa fa-print" aria-hidden="true"></i> พิมพ์รายงานทั้งหมด</a>
                                            <?php } ?>
