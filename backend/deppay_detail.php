    ...
    <div class="wrapper">
                        ...
                        ?>
                            ...
                            <div class="col-md-3 form-inline" style="padding-top: 28px; padding-right: 20px;">
                                <div class="form-group form-check ml-auto">
                                    <input type="radio" class="mr-1" name="pay_type" id="pay_online" value="โอนจ่าย" checked>
                                    <label style="font-size: 24px;" for="pay_online"> โอนจ่าย</label>
                                </div>
                                <div class="form-group form-check ml-3">
                                    <input type="radio" class="mr-1" name="pay_type" id="pay_cash" value="เงินสด" disabled>
                                    ...
                                    <table style="border: 2px solid black;" class="table table-striped table-bordered ">
                                        <thead>
                                            ...
                                            ?>
                                                <tr style="border: 2px solid black;">
                                                    <th style="padding-left: 20%; padding-top: 2%; padding-bottom: 2%;  font-size: 16px;" rowspan="4" colspan="4">รหัสลูกค้า : <?= $row['user_id'] ?><br>ชื่อ-สกุล : <?= $row['fullname'] ?><br>ที่อยู่ : <?= $row['address'] ?><br>อีเมล์ : <?= $row['email'] ?></th>
                                                    <th style="padding-left: 10%; padding-top: 2%; padding-bottom: 2%;  font-size: 16px;" rowspan="4" colspan="4">รหัสสุนัข : <?= $row['dog_id'] ?><br>ชื่อ : <?= $row['dog_name'] ?><br>พันธุ์ : <?= $row['dog_type'] ?><br>อายุ : <?= $row['dog_age'] ?> ปี</th>
                                                </tr>
                                        ...
                                        <tbody>
                                            <tr style="border: 2px solid black;" align="center">
                                                ...
                                                <th style="width: 10%; border: 2px solid black;">วันที่สิ้นสุดการให้บริการ</th>
                                                <th style="width: 10%; border: 2px solid black;">ประเภทห้อง</th>
                                                <th style="width: 20%; border: 2px solid black;">หลักฐานการโอนเงิน</th>
                                                <th style="width: 5%; border: 2px solid black;">ราคา</th>
                                            </tr>
                                            <tr align="center">
                                                <td style="width: 5%; border: 2px solid black;"><?= $row["dep_id"] ?></td>
                                                <td style="width: 5%; border: 2px solid black;"><?= $row["dep_sdate"] ?></td>
                                                <td style="width: 5%; border: 2px solid black;"><?= $row["dep_edate"] ?></td>
                                                <td style="width: 5%; border: 2px solid black;"><?= $row["room_type"] ?></td>
                                                ...
                                                <td style="width: 5%; border: 2px solid black;"><?= $row["dep_price"] ?></td>
                                            </tr>
                                            <!-- <tr>
                                                <td style="border: 2px solid black; padding-left: 73%;" rowspan="1" colspan="5">ส่วนลด</td>
                                                <td style="border: 2px solid black;" class="text-center" rowspan="1" colspan="4">0</td>
                                            </tr> -->
                                            <tr>
                                                <th style="border: 2px solid black; padding-left: 71%;" rowspan="1" colspan="5">รวมเป็นเงิน (Total)</th>
                                                <th class="text-center" rowspan="1" colspan="4"><?= $row['dep_price'] ?></th>
                                            </tr>
        ...
        <script>
            $("#updateForm").submit(function(e) {
                ...
                $.post('../api/pay/dep_pay.php', formData, function(data) {
                    if (data.success) {
                        swal("แจ้งเตือน", "อัปเดตสถานะการชำระสำเร็จ", "success").then(function() {
                            window.location = "dep_pay.php";
                        })
                    } else {
