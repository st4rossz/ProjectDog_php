      ...
      <div class="content" style="font-family: Kanit Thin;">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <!-- <div class="header"> -->
              <h4 class="title">เพิ่มบันทึกการติดตามสุนัข (ฝากเลี้ยง) </h4>
              <hr>
              <?php
              $dep_id = $_GET['dep_id'];
              ...
              while ($row = mysqli_fetch_assoc($query)) {
                ...
                <form method="POST" action="../api/record/dep_record.php">
                  ...
                  <div class="col-md-12">
                    ...
                    <textarea class="form-control" type="text" id="exampleFormControlTextarea1" rows="3" name="deprec_detail_show" disabled><?= $row['deprec_detail']; ?></textarea>
                  </div>
                  <div class="col-md-12">
                    <label for="inputdogsickness" class="form-label">กรอกการติดตามสุนัขครั้งนี้</label>
                  </div>
                  <div class="col-md-12">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deprec_detail"></textarea>
                  </div>
                  <div class="col-md-12">
