    ...
    <div class="wrapper">
                                ...
                                <div class="content table-full-width">
                                    <table style="border: 2px solid black;" class="table table-striped table-bordered ">
                                        <thead>
                                            ...
                                            ?>
                                                <tr style="border: 2px solid black;">
                                                    <th style="padding-left: 20%; padding-top: 2%; padding-bottom: 2%;  font-size: 16px;" rowspan="4" colspan="3">รหัสลูกค้า : <?= $row['user_id'] ?><br>ชื่อ-สกุล : <?= $row['fullname'] ?><br>ที่อยู่ : <?= $row['address'] ?><br>อีเมล์ : <?= $row['email'] ?></th>
                                                    <th style="padding-left: 0%; padding-top: 2%; padding-bottom: 2%;  font-size: 16px;" rowspan="4" colspan="2">รหัสสุนัข : <?= $row['dog_id'] ?><br>ชื่อ : <?= $row['dog_name'] ?><br>พันธุ์ : <?= $row['dog_type'] ?><br>อายุ : <?= $row['dog_age'] ?> ปี</th>
                                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th style="border: 2px solid black; padding-left: 71%;" rowspan="1" colspan="4">รวมเป็นเงิน (Total)</th>
                                                <th class="text-center" rowspan="1" colspan="3"><?= $row['dep_price'] ?></th>
                                            </tr>
        ...
        <script>
            $("#updateForm").submit(function(e) {
                ...
                $.post('../api/pay/depcash_pay.php', formData, function(data) {
                    if (data.success) {
