        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center d-flex justify-content-center">
                <table class="table table-striped table-dark" style="margin-left: 15%; margin-right: 15%; margin-bottom: 5%;box-shadow: 0px 0px 4px 4px  grey;">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM use_service INNER JOIN dog on (use_service.dog_id = dog.dog_id) INNER JOIN service on (use_service.service_id = service.service_id) WHERE user_id = '$user_id' ORDER BY us_status";
