...
<body class="" style="font-family: Kanit Thin;">
    ...
    <div class="bg">
        <div class="" style="padding-top: 20%; padding-left: 15%; ">
            ...
            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#bgdetail" data-whatever="@mdo" style="font-family: Kanit thin; border-radius: 100px; box-shadow:0px 0px 10px black">รายละเอียด</button></a>
        </div>
    ...
    <div class="container-fluid" style="background-color: #F4D03F;">
        <div class="row" style="padding-top: 25px;">
            ...
            <div class="col-6 text-center d-flex">
                <table class="table table-bordered table-dark" style="margin-right: 30%; margin-left: auto; margin-top: 5%; margin-bottom: 5%;">
                    <thead>
                        <tr>
                            <th>ชื่อสุนัข</th>
                            <th>พันธุ์สุนัข</th>
