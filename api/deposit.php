...
try {
    ...
    //เริ่มต้นเงื่อนไขการจองห้องพัก
    if ($dep_sdate >= $dep_edate) {
        throw new Exception("โปรดกรอกวันจองให้ถูกต้อง");
        // echo "<script>";
        ...
        throw new Exception("สุนัขตัวนี้มีการจองแล้วในช่วงเวลานี้");
        // echo "<script>";
        // echo "alert(\"วันซ้ำ!\");";
        // echo "window.location=\"../usindex.php\"";
        // echo "</script>";
        ...
        if ($result2['depcheck1'] >= $resultroom1['rq1']) {
            throw new Exception("ห้องพักขนาดเล็กเต็มแล้ว");
            // echo "<script>";
    ...
    if ($dep_sdate >= $dep_edate) {
        ...
        if ($result3['depcheck2'] >= $resultroom2['rq2']) {
            throw new Exception("ห้องพักขนาดใหญ่เต็มแล้ว");
            // echo "<script>";
    ...
    if ($dep_sdate >= $dep_edate) {
        ...
        if ($result4['depcheck3'] >= $resultroom3['rq3']) {
            throw new Exception("ห้องพักพิเศษเต็มแล้ว");
            // echo "<script>";
